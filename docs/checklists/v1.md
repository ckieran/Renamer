...
- [x] 260 Desktop stepper shell (`docs/specs/260-maui-stepper-shell.md`)
- [x] 270 Desktop preview workspace (`docs/specs/270-maui-preview-workspace.md`)
- [x] 280 Desktop apply workspace (`docs/specs/280-maui-apply-workspace.md`)
- [x] 290 String resource extraction (`docs/specs/290-string-resources.md`)
- [ ] 300 UI copy baseline (`docs/specs/300-ui-copy-baseline.md`)
- [ ] 310 Generate copy refresh (`docs/specs/310-generate-copy-refresh.md`)
